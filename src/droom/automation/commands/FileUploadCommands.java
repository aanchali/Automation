...
public class FileUploadCommands {
	 ...
	 */
	public static void uploadFile(WebDriver myDriver, HSSFSheet sheet1,
	...
	public static void uploadFileAndWaitForNextElement(WebDriver myDriver,
	...
	public static void uploadFileForHiddenInput(WebDriver myDriver,
			HSSFSheet sheet1, int row, String screenshotPath,
			LogEntries browserLogEntries, LogEntries driverLogEntries,
			LogEntries performanceLogEntries) {
		final String yes = "Yes";
	...
	public static void uploadFileForHiddenInputAndWaitForNextElement(
